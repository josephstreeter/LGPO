...
secedit /configure /db CIS.db /cfg .\CIS_SVR08R2_MS_Sec_Temp.inf
...
Apply_LGPO_Delta.exe CIS_SVR08R2_MS_Add_Sec.txt CIS_SVR08R2_MS_Event_Log.txt CIS_SVR08R2_MS_Inet_Com.txt CIS_SVR08R2_MS_Term_Serv.txt /log LGPO-Log.txt /error LGPO-ErrorLog.txt
